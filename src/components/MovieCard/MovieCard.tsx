  ...
  return (
    <Link
      ...
      <div
        ...
        />
        {showPlot && (
          <div className='z-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full flex flex-col justify-between items-center p-4 rounded-lg hover:bg-[rgba(0,0,0,0.9)] duration-300'>
            <div>
